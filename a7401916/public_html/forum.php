...
<div id="header-wrapper">
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				<li><a href="index.php" accesskey="1" title="">MAP</a></li>
				<li><a href="user.php" accesskey="2" title="">LOGIN/SIGNUP</a></li>
				<li class="active"><a href="forum.php" accesskey="3" title="">FORUM</a></li>
	...
	<div id="banner" class="container"><span>
		<?php

		if (!isset($_SESSION['SID'])) {
			echo "You need to log in first<br /><br />";
			echo '<a href="user.php">Go to Login</a>';
		}
...
<div id="welcome" class="container" style="color:#FFFFFF">
		<div class="title">
			<h2>Welcome to HealthPal</h2>
		</div>
		<p>We bring easy-to-access blood donor community and health emergency solution.<br />We will be ready for you very soon
		</p>
	</div>
</div>
